        ...
        <div class="card" style="width: 18rem;">
            ...
            @foreach($recipes->where('id', '=', $ur) as $recipe)
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">{{ $recipe->time }} minuti  
                        <button type="button" class="btn btn-secondary"> <a href="{{ route('recipe.delete', $recipe->id) }}"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
