	...
	<div class="row">
		<div class="col-10">
			...
			@else <!-- Altrimenti si visualizza un'immagine predefinita -->
				...
				<img src="https://mdbcdn.b-cdn.net/img/new/avatars/8.webp" class="rounded-circle mb-3" style="width: 150px;" alt="Avatar" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Update your profile picture!"/>
					<!--<br>
