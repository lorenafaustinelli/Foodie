                    ...
                    <tbody>
                      @foreach($recipe_ingredient as $rp)
                        <tr>  
                          ...
                          <td>  {{ $rp->measure }}       </td>
                          <td> 
                            <a class="text-decoration-none" data-bs-toggle="modal" data-target-id="{{ $rp->ingredient_name }}" data-target-id="{{ $rp->id }}"data-target-id="{{ $rp->ingredient_id }}" data-target-rec_id="{{ $rp->quantity }}" data-target-id="{{ $rp->measure }}"  data-bs-target="#updateModal"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                          ...
                          <td>  
                            {{-- <a href="{{ route('recipe_ingredient.delete', $rp->id) }}" class="text-decoration-none"> 
